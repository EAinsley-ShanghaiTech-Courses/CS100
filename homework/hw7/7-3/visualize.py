...
try:
    ...
    print("Package numpy, matplotlib not installed, "
          "use \"python -m pip install numpy matplotlib\" for Installation")

# Color map: index->color, where index in [0, ..., 19]
cmap = [
    "black", "gray", "lightcoral", "maroon", "indigo", "chocolate", "gold",
    "lightseagreen", "lawngreen", "olive", "cyan", "skyblue", "navy", "blue",
    "red", "violet", "hotpink", "lightpink", "azure", "beige"
]
